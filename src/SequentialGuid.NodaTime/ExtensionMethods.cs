...
namespace SequentialGuid.NodaTime
{
    ...
    {
	    /// <summary>
	    /// Will return the value of SystemClock.Instance.GetCurrentInstant() at the time of the generation of the Guid will keep you from storing separate audit fields
	    /// </summary>
